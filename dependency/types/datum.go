...
import (
	...
	"github.com/daiguadaidai/sql_parser/dependency/mysql"
	"github.com/daiguadaidai/sql_parser/dependency/sessionctx/stmtctx"
	"github.com/daiguadaidai/sql_parser/dependency/terror"
	"github.com/daiguadaidai/sql_parser/dependency/types/json"
	"github.com/daiguadaidai/sql_parser/dependency/util/charset"
	"github.com/daiguadaidai/sql_parser/dependency/util/hack"
		...
		if !dec.IsZero() && prec-frac > flen-decimal {
			...
			if !dec.IsZero() && frac > decimal && dec.Compare(&old) != 0 {
				if sc.InInsertStmt || sc.InUpdateOrDeleteStmt {
					// fix https://github.com/daiguadaidai/sql_parser/dependency/issues/3895
					// fix https://github.com/daiguadaidai/sql_parser/dependency/issues/5532
